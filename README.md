...
- **Accent:** `#C5050C` (UW Badger Red)
- **Gold:** `#C49A2A`
- **Fonts:** Red Hat Display (headings), Red Hat Text (body)

## Compliance

- UW-207 branding policy compliant
- WCAG 2.1 AA accessible
- UW-Madison cookie consent (GDPR)

---

**Maintained by** Ümit Bilginer (PhD Student) & Francisco Peñagaricano (PI)
